      ...
      if (navHover == true) {
        ...
        if (isMobile()) {
          ...
          fakeHover.live("vmouseout", function () {
            $(prevNav, wrap).delay(300).animate({ opacity: 0 }, 200);
            $(nextNav, wrap).delay(300).animate({ opacity: 0 }, 200);
            $(commands, wrap).delay(300).animate({ opacity: 0 }, 200);
          });
        } else {
          fakeHover.hover(
            function () {
    ...
    function nextSlide(navSlide) {
      ...
      if (!$(".imgLoaded", slide).length) {
        ...
        if (
          ...
          $(".camera_loader", wrap).delay(300).fadeIn(400);
    ...
    if ($(thumbs).length) {
      ...
      $(".camera_prevThumbs", camera_thumbs_wrap).click(function () {
        ...
        if (ulLeft - sum > 0) {
          ...
          $("ul", thumbs).animate({ "margin-left": 0 }, 300, thumbnailVisible);
        }
      });
